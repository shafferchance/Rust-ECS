...
pub fn create_graphics_pipeline_v1(
    device: &ash::Device,
    ...
    let vert_shader_module = create_shader_module(
        &device, 
        include_bytes!("../../../shaders/spv/9-shader-base.vert.spv").to_vec()
    );
    let frag_shader_module = create_shader_module(
        &device, 
        include_bytes!("../../../shaders/spv/9-shader-base.frag.spv").to_vec()
    );
    ...
    for &image_view in image_views.iter() {
        ...
        let framebuffer = unsafe {
            device
                ...
                .expect("Failed to crate Framebuffer")
        };
